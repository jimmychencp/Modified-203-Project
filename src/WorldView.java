    ...
    private void drawEntities() {
        for (Entity entity : world.entities) {
            ...
            if (viewport.contains(pos)) {
                ...
                if (entity.getClass() == EvilFairy.class || entity.getClass() == EvilFairyAttacking.class ||
                        entity.getClass() == Priest.class || entity.getClass() == PriestAttacking.class) {
                    screen.image(entity.getCurrentImage(),
                            (viewPoint.x * tileWidth) - 25,
                            (viewPoint.y * tileHeight) - 50);
                }
                else    {
                    screen.image(entity.getCurrentImage(),
